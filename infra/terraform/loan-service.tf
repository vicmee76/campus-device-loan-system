# Loan Service App Service
resource "azurerm_linux_web_app" "loan_service" {
...
# Application Insights for Loan Service (optional monitoring)
resource "azurerm_application_insights" "loan_service" {
  name                = "campus-loan-service-insights-${var.environment}"
